 ...
 * @Description TODO(测试 semaphore 类的用法
 * 		负责协调各个线程，以保证它们能够正确、合理的使用公共资源的设施，也是操作系统中用于控制进程同步互斥的量。
 * 	Semaphore是一种计数信号量，用于管理一组资源，内部是基于AQS的共享模式。它相当于给线程规定一个量从而控制允许活
 * 	动的线程数
 * )   
 * @author lin.pf 
 * @date 2019年2月28日 下午4:57:32     
			...
			threads[i] = new Thread(new Runnable() {
				...
				public void run() {
					try {
						...
						System.out.println(Thread.currentThread().getName() + "当前剩余停车位：" + semaphore.availablePermits());
						Thread.sleep(3000);
